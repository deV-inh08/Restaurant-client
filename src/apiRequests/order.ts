...
import { CreateOrdersBodyType, CreateOrdersResType, GetOrderDetailResType, GetOrdersQueryParamsType, GetOrdersResType, PayGuestOrdersBodyType, PayGuestOrdersResType, UpdateOrderBodyType, UpdateOrderResType } from "@/schema/order.schema"
import queryString from 'query-string'

const orderApiReq = {
    createOrder: (body: CreateOrdersBodyType) => http.post<{ payload: CreateOrdersResType }>('/orders', body),
