...
import { GetOrdersResType, PayGuestOrdersResType, UpdateOrderResType } from '@/schema/order.schema'
...
export default function OrderTable() {
  ...
  useEffect(() => {
    ...
    function onUpdateOrder(data: UpdateOrderResType['data']) {
      ...
      toast(`Món ăn ${name} vừa được cập nhật sang trạng thái ${getVietnameseOrdersStatus(data.status)}`, {
        duration: 4000
      })
      refetch()
    }
                  ...
                  <CommandList>
                    {OrderStatusValues.map((status) => (
                      ...
                      >
                        ...
                        />
                        {getVietnameseOrdersStatus(status)}
                      </CommandItem>
                    ))}
                  </CommandList>
                </CommandGroup>
